    ...
    if (typeof id == 'string') {
        ...
        if (d['mesbot'][id]['type'] !== undefined) {
            ...
            if (d['mesbot'][id]['type'] == 'phone') {
                ...
                $(".chatcont").append('<div class="message meshide mesbot" data-mesbot="' + id + '" data-stepbot="' + stepbot + '"><div class="mesimg"></div><div class="mescont"><div class="mestext">' + text + '</div><div class="butslink butslinkhide"><div class="descagree">Продолжая, вы соглашаетесь с <a href="https://callkeeper.ru/docs/personal_data.pdf" target="_blank">политикой конфиденциальности</a></div><input class="inptext inpname" type="text" placeholder="Ваше имя"><input class="inptext inpphone" type="text" placeholder="+7 (___) ___-__-__"><div class="divbutphone"><button class="butphone">Оставить заявку</button><div class="error errorphone"></div></div></div></div></div>');
